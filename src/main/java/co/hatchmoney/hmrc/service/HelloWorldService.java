...
package co.hatchmoney.hmrc.service;
...
public class HelloWorldService {
    ...
    public String getUserEmployment(String accessToken) throws UnauthorizedException {
        return serviceConnector.get(
                "https://api.service.hmrc.gov.uk/individual-employment/sa/1111111111/annual-summary/2015-16",
                "application/vnd.hmrc.1.0+json",
                Optional.of(accessToken));
    }
}
